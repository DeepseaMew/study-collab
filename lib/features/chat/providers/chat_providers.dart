...
/// Total unread group chat count.
///
/// NOTE: A service method to list all group conversations for the current user
/// does not yet exist in [ChatService]. This provider returns 0 until
/// firebase-specialist adds [watchMyGroupConversations] (see follow-ups).
final unreadGroupTotalProvider = Provider<int>((ref) => 0);
